...
var loader, transform, rendering, animations, collisions, inputs, roguemap, hero;
...
loader.load([
  ...
  .done(function () {
    nuclear.import([transform, rendering, animations, collisions, inputs, roguemap, hero]);
